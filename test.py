...
index = VectorStoreIndex.from_documents(documents, model="mxbai-embed-large", base_url="http://localhost:11434")
query_str = "What is the impact of COVID-19 on the economy?"
